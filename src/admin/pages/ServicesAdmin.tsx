      ...
      <div className="adm-list">
        ...
        {services.map((s) => (
          ...
          >
            ...
            <div
              className="adm-badge"
              style={{ justifySelf: 'start', color: s.hue, borderColor: `${s.hue}55` }}
            >
              {s.slug}
            </div>
            <div style={{ color: 'var(--fg-dim)', fontSize: 13 }}>{s.tag}</div>
            <div style={{ color: 'var(--fg-dim)', fontSize: 13 }}>{s.packages.length}</div>
